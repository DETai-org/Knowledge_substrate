...
CREATE TABLE IF NOT EXISTS publications.similarity_edges (
...
CREATE INDEX IF NOT EXISTS similarity_edges_source_idx ON publications.similarity_edges (source_id);
CREATE INDEX IF NOT EXISTS similarity_edges_target_idx ON publications.similarity_edges (target_id);
CREATE INDEX IF NOT EXISTS similarity_edges_weight_idx ON publications.similarity_edges (weight DESC);

...
- **Концептуальная задумка** размещена в базе знаний на MkDocs: [Semantic Similarity Graph — Explanation](https://docs.detai-x.com/ru/ecosystem/Infrastructure/Knowledge_Substrate/knowledge_core/Explanation/)

...
ADR/
Policy/
Некоторые типы связанных документов по архитектуре системы могут находиться **в других хранилищах** (см.🐝 Архитектура U.L.I. [[documentation-architecture-U-L-I|Документационная архитектура U.L.I.]])

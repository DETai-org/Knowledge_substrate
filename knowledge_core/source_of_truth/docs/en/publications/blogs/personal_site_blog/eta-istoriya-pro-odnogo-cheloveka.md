...
descriptive:
  ...
  preview: "Притча о молодом человеке, который ищет секрет успеха и проходит через испытание на пляже. Рассказ показывает, что преодоление рождается в борьбе за жизнь."
  seoLead: "История о том, как желание успеха проверяется пределом выносливости и почему настоящая мотивация рождается в борьбе."
  taxonomy:
...
# Эта история про одного человека

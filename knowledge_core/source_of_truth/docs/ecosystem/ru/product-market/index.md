...
Product–Market System превращает миссию DETai и реальные потребности людей в проверяемые предложения, продукты, услуги и устойчивые способы их доставки. Она проходит через институциональный и технологический слои, но не подменяет ни метод, ни профессиональную ответственность, ни разработку.

## Что система удерживает

- сегменты, роли пользователя, покупателя, плательщика и бенефициара;
- проблемы и jobs-to-be-done, которые действительно существуют;
- собственное ценностное предложение каждого продукта или услуги и границы обещаний;
- Product Charter каждого продукта или услуги;
...
Экосистема DETai как целое не является одним продаваемым продуктом. Базовой единицей является конкретное предложение: психотерапевтическая услуга, образовательная программа, цифровой сервис, инфраструктурная возможность или иной оформленный продукт.

Каждая единица должна иметь собственный [Product Object](product-object-model.md), владельца, аудиторию, intended outcome, ограничения, модель доставки, метрики и статус.
...
[Business Thesis DETai](business-thesis.md) удерживает гипотезу предпринимательского целого. Она не заменяет ценностные предложения продуктов: `Psychology in Quotes`, психотерапевтическая услуга, образовательная программа и будущий цифровой workspace отвечают на разные проблемы и проходят собственные evidence gates.
...
`DETai Insight Workspace` пока не добавляется в каталог как действующий продукт. Его статус и условия перехода к product node зафиксированы в [Lead Product Decision](lead-product-decision.md).
...
- [Выбор lead product](lead-product-decision.md)

...
Проект может быть внешним пользовательским решением, контентным проектом, внутренним инструментом или инфраструктурой. Он не обязан становиться продуктом, но должен создавать или увеличивать хотя бы один [ресурс экосистемы](../ecosystem/Management_layer/ecosystem-resource.md): финансовый, командный, технологический, ресурс узнаваемости или аналитический.

...
```text
connectors/
├── telegram.py    # отправить сообщение, загрузить файл, получить update
├── vk.py          # вызвать VK API
├── github.py      # создать issue, прочитать PR
├── google_docs.py # прочитать/записать документ
├── openai.py      # вызвать модель
└── webhook.py     # отправить/принять webhook
```

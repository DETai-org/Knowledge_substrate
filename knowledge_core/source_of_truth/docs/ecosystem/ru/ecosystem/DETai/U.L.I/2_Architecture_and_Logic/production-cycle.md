...
Проект может создавать внешнюю или внутреннюю ценность. Он может стать пользовательским продуктом, а может остаться инфраструктурой, внутренним инструментом, медиа-проектом или технической capability. В любом случае проект должен усиливать хотя бы один [ресурс экосистемы](../../../Management_layer/ecosystem-resource.md).
...
Изменившийся продуктовый смысл не считается синхронизированным, пока Management Layer не подтвердил, что связанные представления обновлены либо явно отмечены как неприменимые. Сквозное правило описано в [карте источников истины](../../../../architecture/source-of-truth-map.md#management-оркестрация-зависимых-представлений).
...
Подробная продуктовая сторона интерфейса описана в [модели продуктового объекта](../../../../product-market/product-object-model.md), [стандарте ценностного предложения](../../../../product-market/value-proposition-standard.md) и [рыночном и портфельном цикле](../../../../product-market/market-operations.md). Явная последовательность передачи ответственности дана в [интерфейсе производственного и продуктового циклов](../../../../technology/system-interface.md#эстафета-публичного-релиза).

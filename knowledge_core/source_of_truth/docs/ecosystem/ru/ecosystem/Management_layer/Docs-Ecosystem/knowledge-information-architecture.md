...
2. **Архитектура** — канон, онтология, сквозные системы и источники истины.
3. **Метод и институт** — DET, психотерапия, образование и исследование; внутренняя теория синхронизируется отдельным процессом части II.
4. **Технологический слой** — Platform DETai как доставка и U.L.I. как Human–AI Development Environment создания.
5. **Governance и команда** — смысловые основания, decision rights, Operating Model и Team OS.
6. **Сквозные системы** — Product–Market, Legal–Economic, Trust и Evidence как самостоятельные соседние разделы.
7. **Knowledge и Delivery** — архитектура знания, инфраструктура, delivery, инструменты и публичные коммуникации.

Языковые входы остаются отдельными пунктами до проектирования общего language navigation. Инструменты показываются как средства работы, а не как архитектурные центры экосистемы.

...
links:
  external_links:
    - type: "MkDocs_ru"
      url: "https://docs.detai-x.com/ru/ecosystem/Management_layer/2_Architecture_and_Logic/docs-as-executable-interface-for-agents/"
  document_links:
    - schema: ""
      link_type: ""
      linked_document_id: ""
...
У нас смотри в [♻️ Процесс версионности в U.L.I.](https://docs.detai-x.com/ru/ecosystem/DETai/U.L.I/3_Technical_Standards/Versioning-in-U.L.I/)
...
У нас смотри в [Документационная архитектура U.L.I.](https://docs.detai-x.com/ru/ecosystem/DETai/U.L.I/2_Architecture_and_Logic/documentation-architecture-U-L-I/)
...
У нас смотри в [Work Model](https://docs.detai-x.com/ru/ecosystem/DETai/U.L.I/3_Technical_Standards/work-model/work-model/)
...
У нас смотри в [index](https://docs.detai-x.com/ru/ecosystem/Ecosystem/Infrastructure/Knowledge_Substrate/)

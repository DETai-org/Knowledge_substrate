...
Большая цель, зафиксированная на уровне Epic Issue, дробится на Sub-Issue, каждая из которых завершает отдельный фрагмент смысла и результата. Завершение Epic Issue означает не просто окончание набора действий, а **переход проекта / репозитория / инициативы в новое состояние**. В зависимости от контекста это может означать:
